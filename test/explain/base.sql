	...
	*/
	...
	------------------------------ ---------- ---------- ---------- ---------- -----------
	BASE:INSERT-CONCILIATION                1          1          0                      1
	BASE:SELECT-1                          23         23    1485611         61           1
	BASE:SELECT-2                          34         34    1610383        246           1
	BASE:SELECT-3                           2          2      11631         12           1
	BASE:SELECT-4                          35         34   20532047       2442          11
	BASE:UPDATE-HOTEL_STATE                 2          2      11671        216           1
	BASE:UPDATE-PAYMENT_ORDER               2          2      11731         59           1
	*/
	...
	/* --------------------------------------------------------------------- */
	EXPLAIN PLAN
		SET STATEMENT_ID = 'BASE:SELECT-1'
		INTO PLAN_TABLE FOR
			select /*+ MERGE */
	...
	/* --------------------------------------------------------------------- */
	EXPLAIN PLAN
		SET STATEMENT_ID = 'BASE:INSERT-CONCILIATION'
		INTO PLAN_TABLE FOR
	...
	/* --------------------------------------------------------------------- */
	EXPLAIN PLAN
		SET STATEMENT_ID = 'BASE:SELECT-3'
		INTO PLAN_TABLE FOR
	...
	/* --------------------------------------------------------------------- */
	EXPLAIN PLAN
		SET STATEMENT_ID = 'BASE:SELECT-4'
		INTO PLAN_TABLE FOR
